...
## Story: 
This project was born out of frustration with the tedium of network obstructions 
to maximising the flexibility of development & small scale / IoT service publishing.
